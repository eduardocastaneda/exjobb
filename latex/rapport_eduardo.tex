...
Kommande kapitler är indelade i \textit{bakgrund}, \textit{teori}, \textit{metod}, \textit{resultat} och \textit{diskussion}. I \textit{bakgrund} beskrivs ökningen av användandet av mobil och desktop, samt vilken betydelse detta har för webbutvecklingen och varför responsive web design är en metod som kan gynna detta. I kapitlet \textit{teori} förklaras tekniken responsive web design samt de verktyg och metoder som samverkar för att få en fungerande responsiv webbplats, detta för att få en teknisk förståelse för webbutvecklingen av mobile-first och desktop-first. Metoderna för arbetet är en litteraturstudie samt en prototyp av en webbsida som både utvecklas i mobile-first och desktop-first, i kapitlet beskrivs valet av metod samt hur dessa samspelar till att få fram resultat som besvarar frågeställningarna för arbetet. I nästa kapitel samlas resultatet från både litteraturstudien och utvecklingen av prototypen, som senare diskuteras i kapitlet \textit{diskussion}, där även frågeställningarna besvaras. 
